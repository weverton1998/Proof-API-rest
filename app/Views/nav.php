            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" style="color: #000;" href="/tabela">Inicio</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" style="color: #000;" href="/tabela/cadastrar">Cadastrar</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" style="color: #000;" href="/tabela/filtrar">Filtrar</a>
                    </li>
                </ul>
            </div>
        </div>
